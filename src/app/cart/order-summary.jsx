...
export async function OrderSummary({ activeOrder }) {
    return (<div className="border rounded-lg p-6 bg-card sticky top-4">
            ...
            <div className="space-y-2 mb-4">
                ...
                {activeOrder.discounts && activeOrder.discounts.length > 0 && (<>
                        {activeOrder.discounts.map((discount, index) => (<div key={index} className="flex justify-between text-sm text-green-600">
