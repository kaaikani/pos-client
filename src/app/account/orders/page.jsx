...
export default async function OrdersPage(props) {
    ...
    const { data } = await query(GetCustomerOrdersQuery, {
        options: {
            take: ITEMS_PER_PAGE,
            skip,
            filter: {
            ...
            {orders.length === 0 ? (<div className="text-center py-12">
                    ...
                    <div className="border rounded-lg">
                        <Table>
                            ...
                            <TableBody>
                                {orders.map((order) => (<TableRow key={order.id} className="hover:bg-muted/50">
                    ...
                    if (page === 1 ||
                        ...
                        return (<PaginationItem key={page}>
                                                        <PaginationLink href={`/account/orders?page=${page}`} isActive={page === currentPage}>
                                                            {page}
                                                        </PaginationLink>
                                                    </PaginationItem>);
                    }
