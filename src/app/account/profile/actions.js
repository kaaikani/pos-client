...
import { UpdateCustomerPasswordMutation, UpdateCustomerMutation, RequestUpdateCustomerEmailAddressMutation, } from '@/lib/vendure/mutations';
...
export async function requestEmailUpdateAction(prevState, formData) {
    const password = formData.get('password');
    const newEmailAddress = formData.get('newEmailAddress');
