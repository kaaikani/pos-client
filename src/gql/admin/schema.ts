...
export type Ledger = Node & {
  ...
  payments: Array<LedgerPayment>;
  status: LedgerStatus;
  type: LedgerType;
  updatedAt: Scalars['DateTime']['output'];
};

export type LedgerPayment = Node & {
...
export type LedgerSummary = {
  ...
  totalPayable: Scalars['Int']['output'];
  totalPurchase: Scalars['Int']['output'];
  totalReceivable: Scalars['Int']['output'];
...
export type Mutation = {
  ...
  posCreateUser: PosUser;
  posDeleteUser: Scalars['Boolean']['output'];
  posLogin: PosAuthResult;
  posUpdateUser: PosUser;
...
export type MutationPosCreateUserArgs = {
  input: CreatePosUserInput;
};


export type MutationPosDeleteUserArgs = {
  id: Scalars['ID']['input'];
};


export type MutationPosLoginArgs = {
  loginRole: Scalars['String']['input'];
  password: Scalars['String']['input'];
  username: Scalars['String']['input'];
};


export type MutationPosUpdateUserArgs = {
  id: Scalars['ID']['input'];
...
export type PharmaItem = Node & {
  ...
  gstPercent: Scalars['Float']['output'];
  hsnCode: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  incentivePct: Scalars['Float']['output'];
  isExpiryEnabled: Scalars['Boolean']['output'];
  isWeightBased: Scalars['Boolean']['output'];
  itemName: Scalars['String']['output'];
  lastPurchaseRate: Scalars['Float']['output'];
  lastSaleRate: Scalars['Float']['output'];
  maxStkQty: Scalars['Float']['output'];
  maxStock: Scalars['Float']['output'];
  mfgDate: Scalars['String']['output'];
  mfr: Scalars['String']['output'];
  minStkQty: Scalars['Float']['output'];
  minStock: Scalars['Float']['output'];
  mrpRate: Scalars['Float']['output'];
  packingUnit: Scalars['String']['output'];
  profitMargin: Scalars['Float']['output'];
  purchaseRate: Scalars['Float']['output'];
  rateA: Scalars['Float']['output'];
  rateB: Scalars['Float']['output'];
  rateC: Scalars['Float']['output'];
  rateD: Scalars['Float']['output'];
  salesRate: Scalars['Float']['output'];
  serialNo: Scalars['String']['output'];
  size: Scalars['String']['output'];
  sizesJson: Scalars['String']['output'];
...
export type PharmaItemInput = {
  ...
  cRate?: InputMaybe<Scalars['Float']['input']>;
  ...
  incentivePct?: InputMaybe<Scalars['Float']['input']>;
  isExpiryEnabled?: InputMaybe<Scalars['Boolean']['input']>;
  isWeightBased?: InputMaybe<Scalars['Boolean']['input']>;
  itemName: Scalars['String']['input'];
  maxStkQty?: InputMaybe<Scalars['Float']['input']>;
  maxStock?: InputMaybe<Scalars['Float']['input']>;
  mfgDate?: InputMaybe<Scalars['String']['input']>;
  mfr?: InputMaybe<Scalars['String']['input']>;
  minStkQty?: InputMaybe<Scalars['Float']['input']>;
  minStock?: InputMaybe<Scalars['Float']['input']>;
  mrpRate?: InputMaybe<Scalars['Float']['input']>;
  packingUnit?: InputMaybe<Scalars['String']['input']>;
  profitMargin?: InputMaybe<Scalars['Float']['input']>;
  purchaseRate?: InputMaybe<Scalars['Float']['input']>;
  rateA?: InputMaybe<Scalars['Float']['input']>;
  rateB?: InputMaybe<Scalars['Float']['input']>;
  rateC?: InputMaybe<Scalars['Float']['input']>;
  rateD?: InputMaybe<Scalars['Float']['input']>;
...
export type PharmaPayment = Node & {
  ...
  otherState: Scalars['Boolean']['output'];
  payDate: Scalars['String']['output'];
  payNo: Scalars['String']['output'];
  payType: Scalars['String']['output'];
  refNo: Scalars['String']['output'];
  rowsJson: Scalars['String']['output'];
  supplierGST: Scalars['String']['output'];
  supplierName: Scalars['String']['output'];
  totalDisc: Scalars['Float']['output'];
  totalNet: Scalars['Float']['output'];
  totalPaying: Scalars['Float']['output'];
  transMode: Scalars['String']['output'];
  updatedAt: Scalars['DateTime']['output'];
};
...
export type PharmaPurchase = Node & {
  ...
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
  invDate: Scalars['String']['output'];
  invNo: Scalars['String']['output'];
  netAmount: Scalars['Float']['output'];
  orderRef: Scalars['String']['output'];
  otherState: Scalars['Boolean']['output'];
  payType: Scalars['String']['output'];
  purDate: Scalars['String']['output'];
  purNo: Scalars['String']['output'];
  rowsJson: Scalars['String']['output'];
  supplier: Scalars['String']['output'];
  taxMode: Scalars['String']['output'];
  totalAmount: Scalars['Float']['output'];
  totalDiscA: Scalars['Float']['output'];
  totalTax: Scalars['Float']['output'];
  transMode: Scalars['String']['output'];
  transportName: Scalars['String']['output'];
  updatedAt: Scalars['DateTime']['output'];
};
...
export type PharmaPurchaseInput = {
  ...
  otherState?: InputMaybe<Scalars['Boolean']['input']>;
  payType?: InputMaybe<Scalars['String']['input']>;
  purDate: Scalars['String']['input'];
  purNo: Scalars['String']['input'];
  rows?: InputMaybe<Array<Scalars['JSON']['input']>>;
  supplier: Scalars['String']['input'];
  taxMode?: InputMaybe<Scalars['String']['input']>;
  totalAmount?: InputMaybe<Scalars['Float']['input']>;
  totalDiscA?: InputMaybe<Scalars['Float']['input']>;
...
export type PharmaReceipt = Node & {
  ...
  cashDisc: Scalars['Float']['output'];
  createdAt: Scalars['DateTime']['output'];
  docDate: Scalars['String']['output'];
  docNo: Scalars['String']['output'];
  docType: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  narration1: Scalars['String']['output'];
  narration2: Scalars['String']['output'];
  payMode: Scalars['String']['output'];
  recAmount: Scalars['Float']['output'];
...
export type PharmaReceiptInput = {
  ...
  cashDisc?: InputMaybe<Scalars['Float']['input']>;
  docDate: Scalars['String']['input'];
  docNo: Scalars['String']['input'];
  docType?: InputMaybe<Scalars['String']['input']>;
  narration1?: InputMaybe<Scalars['String']['input']>;
  narration2?: InputMaybe<Scalars['String']['input']>;
  payMode?: InputMaybe<Scalars['String']['input']>;
  recAmount?: InputMaybe<Scalars['Float']['input']>;
...
export type PharmaSale = Node & {
  ...
  billRef: Scalars['String']['output'];
  billTime: Scalars['String']['output'];
  bookNo: Scalars['String']['output'];
  cardAmount: Scalars['Float']['output'];
  cashAmount: Scalars['Float']['output'];
  changeReturned: Scalars['Float']['output'];
  createdAt: Scalars['DateTime']['output'];
...
export type PharmaSaleInput = {
  ...
  billRef?: InputMaybe<Scalars['String']['input']>;
  billTime?: InputMaybe<Scalars['String']['input']>;
  bookNo?: InputMaybe<Scalars['String']['input']>;
  cardAmount?: InputMaybe<Scalars['Float']['input']>;
  cashAmount?: InputMaybe<Scalars['Float']['input']>;
  changeReturned?: InputMaybe<Scalars['Float']['input']>;
  ...
  salesMan?: InputMaybe<Scalars['String']['input']>;
  subtotal?: InputMaybe<Scalars['Float']['input']>;
  taxAmount?: InputMaybe<Scalars['Float']['input']>;
  transportCharges?: InputMaybe<Scalars['Float']['input']>;
...
export type PharmaToken = Node & {
  ...
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
  injAmt: Scalars['Float']['output'];
  patientName: Scalars['String']['output'];
  tokenDate: Scalars['String']['output'];
  tokenNo: Scalars['Int']['output'];
  tokenTime: Scalars['String']['output'];
...
export type PharmaTokenInput = {
  ...
  injAmt?: InputMaybe<Scalars['Float']['input']>;
  patientName: Scalars['String']['input'];
  tokenDate: Scalars['String']['input'];
  tokenNo: Scalars['Int']['input'];
  tokenTime?: InputMaybe<Scalars['String']['input']>;
  total?: InputMaybe<Scalars['Float']['input']>;
};

export type PosAuthResult = {
  __typename?: 'PosAuthResult';
...
export type QueryPosValidateTokenArgs = {
  token: Scalars['String']['input'];
};
